...
function displayClubDetails(resData) {
    document.querySelector('main').innerHTML =
      ...
      <section class="Reviews">
          ...
          <div class="review-header">
              <h2>Нийт санал</h2>
              <button type="button" class="writeReview">Санал өгөх</button>
          </div>
          <div class="line"></div>
...
// //Comment bichih
// function writeComment(resId){
//   const commentForm = document.querySelector('.writeReview');
